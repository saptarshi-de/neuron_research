...
#define nrn_init _nrn_init__Adapt
#define _nrn_initial _nrn_initial__Adapt
#define nrn_cur _nrn_cur__Adapt
#define _nrn_current _nrn_current__Adapt
#define nrn_jacob _nrn_jacob__Adapt
#define nrn_state _nrn_state__Adapt
#define _net_receive _net_receive__Adapt 
#define state state__Adapt 
...
#define iadapt _p[3]
#define iadapt_columnindex 3
#define g _p[4]
#define g_columnindex 4
#define Dg _p[5]
#define Dg_columnindex 5
#define v _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Adapt /Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/adapt.mod\n");
...
{  double* _p; Datum* _ppvar; Datum* _thread; NrnThread* _nt;
 ...
 _tsav = t; {
    ...
    double __state = g;
    double __primary = (g + _args[0] * gmax) - __state;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/adapt.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "    POINT_PROCESS Adapt\n"

...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal /Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/cal.mod\n");
...
static int _reset;
static char *modelname = "L-type calcium channel (cal)";
...
static int  _f_rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lalpha = 0.055 * ( - 27.0 - _lv ) / ( exp ( ( - 27.0 - _lv ) / 3.8 ) - 1.0 ) ;
   _lbeta = 0.94 * exp ( ( - 75.0 - _lv ) / 17.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/cal.mod";
static const char* nmodl_file_text = 

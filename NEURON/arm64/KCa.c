...
#define caix caix_KCa
 double caix = 0.001;
#define mtau mtau_KCa
 double mtau = 0;
#define minf minf_KCa
 double minf = 0;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 KCa /Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/KCa.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KCa channel from Destexhe et al., 1994";
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  states();
 if(error){fprintf(stderr,"at line 36 in file KCa.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/pradipkumarde/Desktop/Research/SURF/Neurons/NEURON/KCa.mod";
static const char* nmodl_file_text = 
